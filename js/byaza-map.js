...
var layer = L.tileLayer.zoomify('./byaza-map/{g}/{z}-{x}-{y}.jpg', {
...
var baseMaps = {
    "Byaza": byaza,        // The value within quotation marks is the name of the switchable control as it appears on the map. The second value is the layer name.
};
...
L.control.layers(baseMaps, byazaMaps).addTo(map);